...
module.exports = {
    ...
    execute(client, message) {
        ...
        embed.setDescription(`> Volum: **${queue.volume}**%\n> Durata: **${trackDuration}**\nMod de repetare: **${methods[queue.repeatMode]}**\n> Pusa de: ${track.requestedBy}`);
        ...
        saveButton.setLabel('Salveaza aceasta muzica.');
